    ...
    if(isCaller) {
        ...
        dataChannel.onmessage = function (message) {
            if(message.data === "ACK"){
                ...
                latency.push(finalTime - initTime);
                console.log("Latency = " + latency[latency.length - 1]);
            }
            else{
...
// Transfer state through channel.
function transfer() {
...
// Open and read a file's content from local storage.
